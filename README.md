...
-   `absorberBox` is the solid that represents the absorber layer. It has a shape according to the image: ![alt text](https://files.slack.com/files-pri/T12GGHQSK-F0271BXAZB5/absorber_plate.png "absorber")
...
The following is a short python script containing definitions for all of the variables used to describe the physical volumes that can be used to test or calculate. All units are **mm**
