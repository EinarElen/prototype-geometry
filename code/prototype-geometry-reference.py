...
numBarsFront=8
numBarsBack=12
scint_front_vertical_x=numBarsFront * scint_bar_width
scint_front_vertical_y=scint_bar_length
scint_front_horizontal_x=scint_bar_length
scint_front_horizontal_y=numBarsFront * scint_bar_width
scint_back_vertical_x=numBarsBack * scint_bar_width
scint_back_vertical_y=scint_bar_length
scint_back_horizontal_x=scint_bar_length
scint_back_horizontal_y=numBarsBack * scint_bar_width
dx=3000.
dy=3000.
